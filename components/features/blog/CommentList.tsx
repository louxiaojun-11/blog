...
export default function CommentList({ blogId, isOpen, onClose, onCommentSuccess }: CommentListProps) {
  ...
  const loadComments = async () => {
    try {
      setLoading(true)
      const response = await blogService.getComments(blogId, page, pageSize)
      if (response.success) {
